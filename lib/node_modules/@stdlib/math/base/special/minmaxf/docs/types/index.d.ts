...
interface MinMaxf {
	/**
	* Returns the single-precision minimum and maximum values.
	*
	...
	*/
	...
	/**
	* Returns the single-precision minimum and maximum values and assigns results to a provided output array.
	*
	* @param x - first number
	* @param y - second number
