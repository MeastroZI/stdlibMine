...
tape( 'the function returns correctly signed zeros', function test( t ) {
	...
	v = minmaxf( +0.0, -0.0 );
	t.strictEqual( isNegativeZero( float64ToFloat32( v[ 0 ] ) ), true, 'returns -0' );
	t.strictEqual( isPositiveZero( float64ToFloat32( v[ 1 ] ) ), true, 'returns +0' );
	...
	v = minmaxf( -0.0, -0.0 );
	t.strictEqual( isNegativeZero( float64ToFloat32( v[ 0 ] ) ), true, 'returns -0' );
	t.strictEqual( isNegativeZero( float64ToFloat32( v[ 1 ] ) ), true, 'returns -0' );

	v = minmaxf( +0.0, +0.0 );
	t.strictEqual( isPositiveZero( float64ToFloat32( v[ 0 ] ) ), true, 'returns +0' );
	t.strictEqual( isPositiveZero( float64ToFloat32( v[ 1 ] ) ), true, 'returns +0' );
